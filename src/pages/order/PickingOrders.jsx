...
const PickingOrders = () => {
    ...
    const handleStatusUpdate = async (newStatus) => {
        ...
        try {
            ...
            if (data.success) {
                // If it's no longer 'Picking', remove it from this list
    ...
    return (
        <div className="space-y-6 animate-fade-in pb-10">
            ...
            {/* Order Details Modal (Reuse logic from main page) */}
                             ...
                             <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                ...
                                <div className="p-4 bg-orange-50/50 dark:bg-orange-900/10 rounded-lg border border-orange-100 dark:border-orange-800">
                                    ...
                                    <select 
                                        ...
                                        className="w-full bg-white dark:bg-gray-800 border-2 border-orange-200 dark:border-orange-800 text-gray-700 dark:text-gray-200 text-xs rounded-lg p-2 font-bold outline-none focus:ring-2 focus:ring-orange-500 transition-all cursor-pointer"
                                    >
                                ...
                                <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                                    ...
                                    <p className="text-[10px] text-gray-400">SKU: {item.product?.sku || 'N/A'}</p>
                                            ...
                                            <td className="p-3 text-center">
                                                <span className="bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-full font-black text-lg">
                                                    {item.quantity}
                                                </span>
                                            </td>
                                            <td className="p-3">
